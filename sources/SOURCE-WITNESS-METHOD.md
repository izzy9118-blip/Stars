# History of Power — Source Witness Method

## Governing principle

History of Power may not be built from administrative documents alone. Laws, decrees, budgets, correspondence, treaties, corporate records, statistics, and archival orders show what institutions formally did or attempted to do. They do not by themselves disclose how an age understood the form of power it had created, nor what became intelligible only after an event had run its course.

A source is not disqualified because its reflection is retrospective. Temporal distance is a property to record and evaluate, not a reason for exclusion.

## Coequal primary witness classes
...
Limit: these witnesses often show action without supplying a reflective account of the whole in which the action belongs.
...
Every reflective source record should state:
- author and institutional/participant position;
